        ...
        <div class="container px-4 mx-auto">
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-full mb-4 md:w-1/3">
                    <h3 class="mb-1 text-lg font-bold">Contact Us</h3>
                    <p class="mb-1">123 Fashion St, Style City, SC 12345</p>
                    <p class="mb-1">Phone: (123) 456-7890</p>
                    <p>Email: <a href="mailto:info@outletxxx.com"
                            class="text-blue-400 hover:underline">info@outletxxx.com</a></p>
                </div>
                ...
                <button class="btn">
                    ...
                    <div class="container">
                        <svg height="35" width="35" xmlns="http://www.w3.org/2000/svg" version="1.1"
                        ...
                        <!-- Instagram Icon -->
                        <i class="fab fa-instagram" style="font-size: 35px; padding: 2px; color: #000000;"></i>

                        <!-- Facebook Icon -->
                        <i class="fab fa-facebook-f" style="font-size: 35px; padding: 2px; color: #000000;"></i>
                ...
                <!-- About Us -->
                <div class="w-full mb-4 md:w-1/3">
                    <h3 class="mb-1 text-lg font-bold">About Us</h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ac dictum erat. Duis at erat a
                        quam efficitur vehicula.</p>
                </div>
            </div>
            <div class="pt-2 mt-2 text-center border-t border-gray-700">
                <p>&copy; 2024 OutletXXX. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>
